...
<header class="grid-collapse">
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.php"><img src="Homepage_images\logo.png" width="100px" height="90px"></a>
    </div>
...
<section>
	<div class="container">
		<h6 style="color: black; text-align: center;">
			<b><i>ABUNDANT MEAL DEALS FOR EVERY OCCASSION AT AN IRRESISTIBLE PRICE.</i></b>
		</h6>
		<h3 style="color: black; text-align: center;"><b>-----OFFERS-----</b></h3>
		<div class="container-fluid">
		<div class="row">
		<div class="col-lg-12">
			<div class="col-lg-6 col-sm-6" style="text-align: center; color: black;">
				
				<h3 style="text-align: center;"><img src="offers_images\offer1.png" width="70%"></h3>
				<h3 style="text-align: center;color: black;">COUPAN CODE-WOW50</h3>
				<h4 style="text-align: center;color: black;">50% Discount on Medium Pan Pizzas<br>(Only applicable for take away).</h4>
			...
			<div class="col-lg-6 col-sm-6">
				...
				<h3 style="text-align: center;"><img src="offers_images\offer2.jpg" width="200%" height="50%"></h3>
				<h3 style="text-align: right; color: black;">Coupon Code SCP20</h3>
				<h4 style="text-align: center;color: black;">Get 20% off on any Medium Stuffed Crust Pizza</h4>
