...
<section>
	<div class="container-fluid">
		<h1 style="text-align: center; color: black;"><b>-----DRINKS-----<b></h1>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-sm-4" style="color: black;">
					<h3 style="text-align: justify; color: black;">7-UP</h3>
            		<img src="drinks_images\7up.jpg" style="height: 150px; width:150px; border: circle;"><br>
            		<h3 style="text-align: justify; color: black;">Rs 57/-</h3>
            		<button id="cart">Add to Cart</button>
			</div>

			<div class="col-lg-4 col-sm-4" style="color: black;">
				<h3 style="text-align: justify; color: black;">Mirinda</h3>
            		<img src="drinks_images\mirinda.jpg" style="height: 150px; width:150px; border: circle;"><br>
			...
			<div class="col-lg-4 col-sm-4" style="color: black;">
				<h3 style="text-align: justify; color: black;">Pepsi</h3>
            		<img src="drinks_images\pepsi.jpg"" style="height: 150px; width:150px; border: circle;"><br>
            		<h3 style="text-align: justify; color: black;">Rs 57/-</h3>
            		<button id="cart">Add to Cart</button>
			</div>
		</div>
