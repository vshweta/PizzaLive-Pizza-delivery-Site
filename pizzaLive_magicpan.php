...
<html>
<head>
	<title img src="C:\Users\Innocent Devil\Desktop\web\logo.png"> PizzaLive Magic Pan</title>
	<meta charset="utf-8">
...
<section>
	<div class="container">
		<h1  style="text-align: center; color:black ">-----MAGIC PAN-----</h1>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-lg-4 col-sm-4" style="color: black;">
					<h3 style="text-align: justify; color: black;">Paneer & Capsicum</h3>
            		<img src="magicpan_images\paneer-capsicum.jpg" style="height: 180px; width:180px; border: circle;"><br>
            		<h4>Veggie Magic Duo.</h4>
            		<h3 style="text-align: justify; color: black;">Rs 129/-</h3>
            		<button id="cart">Add to Cart</button>
			</div>

			<div class="col-lg-4 col-sm-4" style="color: black;">
				<h3 style="text-align: justify; color: black;">Soya & Onion</h3>
            		<img src="magicpan_images\soya-onion.jpg" style="height: 180px; width:180px; border: circle;"><br>
            		<h4>Veggie Magic Duo.</h4>
			...
			<div class="col-lg-4 col-sm-4" style="color: black;">
				<h3 style="text-align: justify; color: black;">Corn</h3>
            		<img src="magicpan_images\corn.jpg" style="height: 180px; width:180px; border: circle;"><br>
            		<h4>Veggie Magic Solo.</h4>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-sm-12" style="text-align: center;">
				<h3 style="text-align: center; color: black;">Corn</h3>
            		<img src="magicpan_images\corn.jpg" style="height: 180px; width:180px; border: circle;"><br>
            		<h4 style="text-align: center; color: black;">Veggie Magic Solo.</h4>
            		<h3 style="text-align: center; color: black;">Rs 89/-</h3>
            		<button id="cart">Add to Cart</button>
			</div>
		</div>
	</div>
	...
	<div class="container" style="background-color: #800000">
		<div class="row">
				...
				<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
					...
					<li><a href="inside_pizzaLive.php">About Us</li>
